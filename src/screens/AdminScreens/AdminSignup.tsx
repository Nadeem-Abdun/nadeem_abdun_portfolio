...
const AdminSignup = () => {
  ...
  return (
    ...
    >
      ...
      <Grid
        container
        size={{ xl: 6, lg: 6, md: 8, sm: 10, xs: 10 }}
        justifyContent="center"
        alignItems="center"
        rowSpacing={2}
      >
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            onChange={event =>
              handleTextFeildsChange('username', event.target.value)
            }
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            sx={{ backgroundColor: '#D1D5DB', borderRadius: 2 }}
            onChange={event =>
              handleTextFeildsChange('email', event.target.value)
            }
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          ...
          >
            ...
            <FilledInput
              ...
              onChange={event =>
                handleTextFeildsChange('password', event.target.value)
              }
            />
          </FormControl>
        </Grid>
