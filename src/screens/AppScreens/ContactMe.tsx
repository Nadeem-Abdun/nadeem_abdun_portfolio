      ...
      >
        ...
        >
          {loading === false && success === null && (
            <Grid container size={{ xs: 12 }} rowSpacing={2}>
              <Grid size={{ xs: 12 }}>
              ...
              <Grid size={{ xs: formGridSize.visitorName }}>
                <TextField
                  ...
                  onChange={event =>
                    handleTextFeildsChange('visitorName', event.target.value)
                  }
              ...
              <Grid size={{ xs: formGridSize.visitorEmail }}>
                <TextField
                  ...
                  onChange={event =>
                    handleTextFeildsChange('visitorEmail', event.target.value)
                  }
              ...
              <Grid size={{ xs: formGridSize.visitorPhone }}>
                <TextField
                  ...
                  onChange={event =>
                    handleTextFeildsChange('visitorPhone', event.target.value)
                  }
              ...
              <Grid size={{ xs: formGridSize.visitorMessage }}>
                <TextField
                  ...
                  onChange={event =>
                    handleTextFeildsChange('visitorMessage', event.target.value)
                  }
          ...
          {loading === true && success === null && (
            <Grid
              container
              size={{ xs: 12 }}
              rowSpacing={isXl || isLg ? 8 : 10}
            >
              <Grid size={{ xs: 12 }}>
                <div
                  className={`${isXl ? 'mx-80' : isLg ? 'mx-40' : isMd ? 'mx-20' : 'mx-10'} text-center mt-10`}
                >
                  <CircularProgress
                    size={isXl || isLg ? 200 : 150}
                    color="info"
                  />
                </div>
              </Grid>
              <Grid size={{ xs: 12 }} className="text-center">
                <Typography
                  ...
                  fontFamily="inter"
                >
                  Your request is being processed, Please wait while we submit
                  your information...
                </Typography>
              </Grid>
            </Grid>
          ...
          {loading === false && success === true && (
            <Grid container size={{ xs: 12 }} rowSpacing={isXl || isLg ? 1 : 0}>
              <Grid size={{ xs: 12 }}>
                <img
                  src={SuccessLogo}
              ...
              <Grid size={{ xs: 12 }} className="text-center">
                ...
                >
                  ...
                  and we will get back to you soon to continue our conversation.
                </Typography>
              </Grid>
            </Grid>
          )}
            ...
            >
              ...
              <Grid size={{ xs: 12 }} className="text-center">
                <Typography
                  ...
                  fontFamily="inter"
                >
                  Failed to submit your request. Please try again by clicking
                  the button below.
                </Typography>
              </Grid>
              <Grid>
