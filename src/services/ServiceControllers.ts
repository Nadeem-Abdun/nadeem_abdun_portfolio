...
export const GetRefreshToken = async () => {
  return await CommunicationModule(userPaths.RefreshToken, {
    method: 'GET',
    credentials: 'include',
  });
};
...
export const PatchUpdateUserDetails = async (formData: FormData) => {
  return await CommunicationModule(userPaths.UpdateUserDetails, {
    method: 'PATCH',
    body: formData,
    isFormData: true,
    credentials: 'include',
...
export const PostCreateExperience = async (
  formData: Experience,
  profileId: string
) => {
  return await CommunicationModule(
    experiencePaths.CreateExperience(profileId),
    {
      method: 'POST',
      body: formData,
      isFormData: false,
...
export const GetExperienceAllData = async (profileId: string) => {
  return await CommunicationModule(
    experiencePaths.GetAllExperience(profileId),
    {
      method: 'GET',
      credentials: 'include',
    }
...
export const PostCreateSkill = async (
  formData: WallOfCode,
  profileId: string
) => {
...
export const PostCreateContactForm = async (
  formData: ContactMe,
  profileId: string
) => {
  return await CommunicationModule(
    contactMePaths.CreateContactForm(profileId),
    {
      method: 'POST',
      body: formData,
      isFormData: false,
...
export const PatchReplyContactForm = async (
  formData: ContactMe,
  id: string
) => {
...
// Health Check Service Controllers
export const GetHealthCheck = async () => {
  return await CommunicationModule(healthCheckPaths.GetHealthCheckStatus, {
    method: 'GET',
  });
};
