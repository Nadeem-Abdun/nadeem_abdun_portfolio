...
} from '../../redux/experience/experienceSlice';
import {
  formatToLocaleString,
  formatToStringYYYYMMDD,
  ...
  return (
    ...
    >
      <Grid container justifyContent="center" alignItems="center" rowGap={2}>
                  ...
                  >
                    ...
                    <Grid>
                      <IconButton
                        onClick={e => {
                          e.stopPropagation();
                          handleExperienceDialogOpen('delete', item);
                        }}
                      >
        ...
        <Grid>
          <IconButton
            ...
            onClick={() => handleExperienceDialogOpen('add')}
          >
      ...
      <Dialog
        ...
        onClose={() => handleExperienceDialogClose()}
        fullWidth
            ...
            {dialogType === 'add' || dialogType === 'edit' ? (
              <>
                ...
                <Grid size={{ xs: 6 }}>
                  <TextField
                    ...
                    type="date"
                    fullWidth
                    value={formatToStringYYYYMMDD(
                      selectedExperience.joiningDate
                    )}
                    onChange={event =>
                      setSelectedExperience({
                        ...selectedExperience,
                ...
                <Grid size={{ xs: 6 }}>
                  {selectedExperience.relievingDate || dialogType === 'add' ? (
                    <TextField
                      ...
                      fullWidth
                      value={formatToStringYYYYMMDD(
                        selectedExperience.relievingDate
                      )}
                      onChange={event =>
                        setSelectedExperience({
                          ...selectedExperience,
                ...
                <Grid size={{ xs: 12 }}>
                  <TextField
                    ...
                    onChange={event =>
                      handleResponsibilitiesChange(event.target.value)
                    }
                  />
                </Grid>
                <Grid size={{ xs: 12 }}>
              ...
              <Grid size={{ xs: 12 }}>
                <Typography variant="body1" fontWeight={500} fontFamily="inter">
                  ...
                  {selectedExperience?.jobTitle}&quot; experience?
                </Typography>
              </Grid>
            )}
          </Grid>
          ...
          >
            <Grid>
              <Button
                ...
                onClick={() => handleExperienceDialogClose()}
              >
                Close
              </Button>
            </Grid>
            {dialogType === 'add' && (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handlePostCreateExperience()}
                >
                  Add Experience
                </Button>
              </Grid>
            ...
            {dialogType === 'edit' && (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handlePutUpdateExperience()}
                >
                  Update Experience
                </Button>
              </Grid>
