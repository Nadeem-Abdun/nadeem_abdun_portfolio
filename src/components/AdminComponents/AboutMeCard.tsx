    ...
    return (
        <div className={`admin-card ${(isXs) ? 'px-2' : 'px-4'} ${(isXs) ? 'py-2' : 'py-4'} w-full`}>
            <Grid container justifyContent="center" alignItems="center" rowGap={3}>
                ...
                <Grid container item xs={12} justifyContent="center" alignItems="center" flexDirection="column" rowGap={1}>
                    <Grid item>
                        <Typography variant="body1" fontWeight={400} fontFamily='inter'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos tempore accusantium itaque culpa nam porro....</Typography>
                    </Grid>
                    <Grid item>
                        <Typography variant="body1" fontWeight={400} fontFamily='inter'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos tempore accusantium itaque culpa nam porro....</Typography>
                    </Grid>
            ...
            <Dialog open={profilePicDialog} onClose={() => handleProfilePicDialog()} disableEscapeKeyDown maxWidth="lg" fullScreen={isXs}>
                <DialogTitle>
                    <Typography variant="h6" fontWeight={500} fontFamily='inter'>Update Profile Picture</Typography>
                </DialogTitle>
                <DialogContent>
                    <Grid container xs={12} justifyContent="center" alignItems="center" flexDirection="column" rowGap={2}>
                        <Grid item>
                            <img
                                src={ProfilePic}
                                alt='Profile_Picture'
            ...
            <Dialog open={profileDescDialog} onClose={() => handleProfileDescDialog()} disableEscapeKeyDown maxWidth="lg" fullScreen={isXs}>
                <DialogTitle>
                    <Typography variant="h6" fontWeight={500} fontFamily='inter'>Update Profile Description</Typography>
                </DialogTitle>
                <DialogContent>
                    <Grid container xs={12} justifyContent="center" alignItems="center" flexDirection="column" rowGap={2} className="mt-2">
                        <Grid item>
                            <TextField label="Description 1" variant="outlined" multiline value="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos tempore accusantium itaque culpa nam porro...." />
                        </Grid>
                        <Grid item>
                            <TextField label="Description 2" variant="outlined" multiline value="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos tempore accusantium itaque culpa nam porro...." />
                        </Grid>
                    </Grid>
                </DialogContent>
                <DialogActions>
