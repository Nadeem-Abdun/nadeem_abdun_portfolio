...
import { ContactMe, ContactMeState } from "../../redux/contactMe/contactMeSlice";
import ellipsisString from "../../utils/EllipsisString";
import "../../styles/componentStyles.css";

const ContactMeCard: React.FC<ContactMeState> = (props) => {
    const { contactMeForms } = props;
            ...
            <Dialog open={contactRequestDialog} onClose={() => handleContactDialogClose()} fullWidth disableEscapeKeyDown fullScreen={isXs}>
                ...
                <DialogActions>
                    <Grid container xs={12} justifyContent="flex-end" alignItems="center" columnGap={1}>
                        ...
                        {(dialogType === "view") ?
                            <Grid item>
                                <Button variant="contained" color="success" onClick={() => handleContactReply()}>Send Reply</Button>
                            </Grid>
                            :
                            <Grid item>
                                <Button variant="contained" color="error" onClick={() => handleRequestDelete()}>Delete Request</Button>
                            </Grid>
                        }
                    </Grid>
                </DialogActions>
