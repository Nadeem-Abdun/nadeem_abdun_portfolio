            ...
            contactMeForms.map((item, index) => {
              return (
                ...
                >
                  ...
                  >
                    <Grid container size={{ xs: 10 }} direction="column">
                      <Grid>
                        <Typography
                    ...
                    <Grid>
                      <IconButton
                        onClick={e => {
                          e.stopPropagation();
                          handleContactDialogOpen('delete', item);
                        }}
                      >
                  ...
                  <Grid container size={{ xs: 12 }} direction="column">
                    ...
                    <Grid>
                      <Typography
                        ...
                        fontFamily="inter"
                      >
                        {ellipsisString(item.visitorName, 25)}
                      </Typography>
                    </Grid>
                  </Grid>
                  <Grid container size={{ xs: 12 }} direction="column">
                    ...
                    <Grid>
                      <Typography
                        ...
                        fontFamily="inter"
                      >
                        {ellipsisString(item.visitorMessage, 80)}
                      </Typography>
                    </Grid>
                  </Grid>
                  <Grid container size={{ xs: 12 }} direction="column">
                    ...
                    <Grid>
                      <Typography
                        ...
                        fontFamily="inter"
                      >
                        {ellipsisString(item.visitorEmail, 25)}
                      </Typography>
                    </Grid>
                  </Grid>
                  <Grid container size={{ xs: 12 }} direction="column">
                    ...
                    <Grid>
                      <Typography
                        ...
                        fontFamily="inter"
                      >
                        {ellipsisString(item.visitorPhone, 25)}
                      </Typography>
                    </Grid>
                  </Grid>
                    ...
                    <Grid container size={{ xs: 12 }} direction="column">
                      ...
                      <Grid>
                        <Typography
                          ...
                          fontFamily="inter"
                        >
                          {ellipsisString(item.userReplyMessage, 25)}
                        </Typography>
                      </Grid>
                    </Grid>
                  )}
            ...
            {dialogType === 'view' ? (
              <>
                <Grid size={{ xs: 12 }}>
                  ...
                  <Typography
                    ...
                    fontFamily="inter"
                  >
                    {selectedContactRequest?.visitorName}
                  </Typography>
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <Typography
                  ...
                  <Typography
                    ...
                    fontFamily="inter"
                  >
                    {selectedContactRequest?.visitorMessage}
                  </Typography>
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <Typography
                  ...
                  <Typography
                    ...
                    fontFamily="inter"
                  >
                    {selectedContactRequest?.visitorEmail}
                  </Typography>
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <Typography
                  ...
                  <Typography
                    ...
                    fontFamily="inter"
                  >
                    {selectedContactRequest?.visitorPhone}
                  </Typography>
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <Typography
                  ...
                  <TextField
                    ...
                    onChange={event =>
                      setSelectedContactRequest({
                        ...
                        userReplyMessage: event.target.value,
                      })
                    }
                  />
                </Grid>
              ...
              <Grid size={{ xs: 12 }}>
                <Typography variant="body1" fontWeight={500} fontFamily="inter">
                  ...
                  {selectedContactRequest?.visitorName}&apos;s&quot; contact
                  request?
                </Typography>
              </Grid>
            )}
        ...
        <DialogActions>
          ...
          >
            <Grid>
              <Button
                variant="contained"
                color={dialogType === 'view' ? 'error' : 'success'}
            ...
            {dialogType === 'view' ? (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handleReplyContactFormSubmit()}
                >
                  Send Reply
                </Button>
              </Grid>
              ...
              <Grid>
                <Button
                  variant="contained"
                  color="error"
                  onClick={() => handleDeleteContactFormSubmit()}
                >
                  Delete Request
                </Button>
              </Grid>
