...
const ProjectCard: React.FC<Props> = props => {
  ...
  const [projectPictureFile, setProjectPictureFile] = useState<File | null>(
    null
  );
  ...
  const postCreateProjectApiCall = async () => {
    try {
      ...
      if (projectPictureFile)
        formData.append('projectPicture', projectPictureFile);
      ...
      if (selectedProject.skillsInvolved)
        formData.append(
          'skillsInvolved',
          JSON.stringify(selectedProject.skillsInvolved)
        );
      if (selectedProject.websiteUrl)
        formData.append('websiteUrl', selectedProject.websiteUrl);
      if (selectedProject.repositoryUrl)
        formData.append('repositoryUrl', selectedProject.repositoryUrl);
  ...
  const handleFileSelect = (file: File) => {
    setSelectedProject({
      ...selectedProject,
      projectPicture: URL.createObjectURL(file),
    });
      ...
      <Grid container justifyContent="center" alignItems="center" rowGap={2}>
                  ...
                  >
                    ...
                    <Grid>
                      <IconButton
                        onClick={e => {
                          e.stopPropagation();
                          handleProjectDialogOpen('delete', item);
                        }}
                      >
        ...
        <Grid>
          <IconButton
            ...
            onClick={() => handleProjectDialogOpen('add')}
          >
            ...
            {dialogType === 'add' && (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handlePostCreateProjectSubmit()}
                >
                  Add Project
                </Button>
              </Grid>
            ...
            {dialogType === 'edit' && (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handlePutUpdateProjectSubmit()}
                >
                  Update Project
                </Button>
              </Grid>
            ...
            {dialogType === 'delete' && (
              <Grid>
                <Button
                  variant="contained"
                  color="error"
                  onClick={() => handleDeleteProjectDataSubmit()}
                >
                  Delete Project
                </Button>
              </Grid>
