...
const ResumeCard: React.FC<Props> = props => {
  ...
  const postUploadResumeApiCall = async () => {
    try {
      ...
      if (selectedResume.resumeStatus)
        formData.append('resumeStatus', selectedResume.resumeStatus);
  ...
  // OnChange Functions
  const handleResumeStatusChange = (
      ...
      <Grid container justifyContent="center" alignItems="center" rowGap={2}>
                  ...
                  >
                    ...
                    <Grid>
                      <IconButton
                        onClick={e => {
                          e.stopPropagation();
                          handleResumeDialogOpen('delete', item);
                        }}
                      >
        ...
        {resumes?.length === 0 && (
          <Grid size={{ xs: 12 }}>
            ...
            >
              There are no resume to display.
            </Typography>
          </Grid>
        )}
        <Grid>
          <IconButton
            ...
            onClick={() => handleResumeDialogOpen('add')}
          >
                ...
                >
                  <Grid>
                    <Typography
                      ...
                      fontFamily="inter"
                    >
                      Resume Status - {selectedResume.resumeStatus}
                    </Typography>
                  </Grid>
                  <Grid>
                    <Switch
                      onChange={e => handleResumeStatusChange(e)}
                      checked={selectedResume.resumeStatus === 'Active'}
                    />
                  </Grid>
                </Grid>
              </>
            ...
            {dialogType === 'add' && (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handlePostUploadResumeSubmit()}
                >
                  Add Resume
                </Button>
              </Grid>
            ...
            {dialogType === 'edit' && (
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={() => handlePutUpdateResumeSubmit()}
                >
                  Update Resume
                </Button>
              </Grid>
            ...
            {dialogType === 'delete' && (
              <Grid>
                <Button
                  variant="contained"
                  color="error"
                  onClick={() => handleDeleteResumeDataSubmit()}
                >
                  Delete Resume
                </Button>
              </Grid>
